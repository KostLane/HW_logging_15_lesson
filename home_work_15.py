...
logging.basicConfig(filename='fileLog.log', filemode='w', encoding='utf-8', format=FORMAT, style='{', datefmt=DATEFMT, level=logging.NOTSET)
logger = logging.getLogger('main')

parser = argparse.ArgumentParser(description='Программа для работы с прямоугольниками')
parser.add_argument('-width', type=int, help='Ширина прямоугольника')
parser.add_argument('-height', type=int, nargs='?', default=1, help='Высота прямоугольника')
